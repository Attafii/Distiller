...
export function UserNav() {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <Link
        href="/auth/login"
        className="inline-flex items-center justify-center rounded-full border border-border bg-background px-3 py-1.5 text-xs font-medium text-foreground shadow-sm transition-colors hover:bg-muted-2/50"
      >
        Sign in
      </Link>
      <Link
